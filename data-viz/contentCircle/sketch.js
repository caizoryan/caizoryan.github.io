...
class Corporation {
  constructor(posX, posY, name, time, money, titles) {
    this.posX = posX;
    if (money > 9)
    ...
    this.titles = new MultiPeople(posX, posY, titles, time);
    this.name = name;
  }
  render() {
    this.money.render();
...
class People {
  constructor(posX, posY, titles, time) {
    this.xoff = 0;
    this.yoff = 2;
    this.phase = 0.1;
    this.noiseSin = 0.01;
  ...
  render() {
    ...
    for (let i = 0; i < TWO_PI; i += this.titles / 120) {
